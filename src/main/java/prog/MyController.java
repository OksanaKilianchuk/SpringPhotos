...
public class MyController {
    ...
    public ModelAndView onPhotoList() {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("listPage");
        mav.addObject("photosList", photos);
    ...
    public ModelAndView onDeletePhotos(@RequestParam("checkbox") List<String> lstPhotoId) {
        for (String photosId : lstPhotoId) {
            photos.remove(Long.parseLong(photosId));
        }
        return onPhotoList();
    }
